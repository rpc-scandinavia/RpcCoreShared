...
public class RpcActivatorTests {
	...
	public void TestActivator() {
		...
		String guidEmptyAqn2 = guidEmpty.GetAssemblyQualifiedName();
		...
		String stringArrayOneAqn2 = stringArrayOne.GetAssemblyQualifiedName();
		...
		String stringArrayTwoAqn2 = stringArrayTwo.GetAssemblyQualifiedName();
		...
		String genericArrayAqn2 = genericArray.GetAssemblyQualifiedName();
		...
		String genericOneAqn2 = genericOne.GetAssemblyQualifiedName();
		...
		String genericTwoAqn2 = genericTwo.GetAssemblyQualifiedName();
