...
public class RpcAssemblyQualifiedNameTests {
	...
	public RpcAssemblyQualifiedNameTests() {
	...
	public void TestAssemblyQualifiedNameWithNormalType() {
		...
		Assert.AreEqual("7.0.0.0", aqn.VersionString);
	...
	public void TestAssemblyQualifiedNameWithGenericType() {
		...
		Assert.AreEqual("7.0.0.0", aqn.GenericTypeArguments[0].VersionString);
		...
		Assert.AreEqual("7.0.0.0", aqn.GenericTypeArguments[1].VersionString);
	...
	public void TestAssemblyQualifiedNameEquals() {
		RpcAssemblyQualifiedName aqn1 = new RpcAssemblyQualifiedName("System.Guid, System.Private.CoreLib, Version=7.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e");
		RpcAssemblyQualifiedName aqn2 = new RpcAssemblyQualifiedName("System.Guid, System.Private.CoreLib, Version=7.0.0.0, Culture=nb_NO, PublicKeyToken=7cec85d7bea7798e");
