...
public class RpcMemberInfoProperty : RpcMemberInfo {
	...
	private JsonPropertyGroupAttribute propertyJsonGroupAttribute;
	...
	public RpcMemberInfoProperty(PropertyInfo propertyInfo) : base() {
		...
		this.propertyJsonGroupAttribute = this.propertyInfo.GetCustomAttribute<JsonPropertyGroupAttribute>(true);
	} // RpcTypeInfoProperty
	#endregion
